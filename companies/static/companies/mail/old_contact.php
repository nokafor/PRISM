...
$params = array(
    'api_user'  => "$user",
    'api_key'   => "$pass",
    'to'        => "nokafor@princeton.edu", // set TO address to have the contact form's email content sent to
    ...
    Subject: $subject\n
    $message",
    'from'      => "noreply@prism.com", // set from address here, it can really be anything
  );
